...
const val HALF_LECTURE_LENGTH_MINUTES = 45
fun getBreakStartTime(lectureStartTime : LocalTime?, lectureEndTime : LocalTime?) : LocalTime? {
...
fun getBreakEndTime(lectureStartTime : LocalTime?, lectureEndTime : LocalTime?) : LocalTime? {
    lectureStartTime ?: return null
    lectureEndTime ?: return null
    if (ChronoUnit.MINUTES.between(lectureStartTime, lectureEndTime) > HALF_LECTURE_LENGTH_MINUTES * 2) {
...
val TEACHER_NAME_DELIMITER = "\\s+".toRegex()
